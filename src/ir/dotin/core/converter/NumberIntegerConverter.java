...
@FacesConverter(value = "numberIntegerConverter")
public class NumberIntegerConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String value)
        ...
        try {
            return Integer.valueOf(englishNumberString.toString().trim());
        } catch (Exception e) {
            e.printStackTrace();
        }
