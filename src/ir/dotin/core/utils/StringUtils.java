...
/*
    public static void main(String[] arg) {
        ...
        try {
            ...
            System.out.println(" Sting to byte array is :  " + inpBytes);

            String sty2 = encode(inpBytes);
            System.out.println(" base64 encoding to string:  " + sty2);


            byte[] sty11 = decode(sty2);
            System.out.println(" base64 dencoding back to byte[]:  " + sty11);
